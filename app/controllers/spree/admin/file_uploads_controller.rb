class Spree::Admin::FileUploadsController < Spree::Admin::BaseController
  # GET /file_uploads
  ...
  def create
    ...
    respond_to do |format|
      if @file_upload.save
        format.html { redirect_to [:admin,@file_upload], notice: 'File upload was successfully created.' }
        format.json { render json: [:admin,@file_upload], status: :created, location: @file_upload }
      else
